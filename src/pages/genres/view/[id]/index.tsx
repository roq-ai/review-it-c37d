...
import { getGenreById } from 'apiSdk/genres';
import { GenreInterface } from 'interfaces/genre';
import { MediaGenreListPage } from 'pages/media-genres';

function GenreViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('genre', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/genres/edit/${id}`} passHref legacyBehavior>
                    <Button
